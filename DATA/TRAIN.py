...
if __name__=='__main__':
    ...
    parser.add_argument('-BS', '--batch_size', default=10, type=int, help='num batches or csv files per dataloader(64*BS)')
    ...
    torch.save(model.state_dict(),'./exp_state/{}.pth'.format(state_path))   #文件保存到exp_state文件夹中
